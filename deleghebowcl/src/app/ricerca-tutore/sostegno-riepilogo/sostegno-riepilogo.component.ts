...
******************************************************************************/
@Component({
  selector: 'app-sostegno-riepilogo',
  templateUrl: './sostegno-riepilogo.component.html',
  styleUrls: ['./sostegno-riepilogo.component.css']
})
export class SostegnoRiepilogoComponent implements OnInit {
  ...
  failDelegaTest() {
    ...
    this.router.navigate(['nuova-delega', 'tutore', this.fiscalCode, 'sostegno']);
  }
