...
******************************************************************************/
@Component({
  selector: 'app-tutelato',
  templateUrl: './tutelato.component.html',
  styleUrls: ['./tutelato.component.css']
})
export class TutelatoComponent implements OnInit, OnDestroy {
  ...
  public toRiepilogo() {
    this.checkCanProceed();
    if (this.canProceed) {
      this.router.navigate(['nuova-delega', 'tutore', this.fiscalCode, 'riepilogo']);
    }
  }
