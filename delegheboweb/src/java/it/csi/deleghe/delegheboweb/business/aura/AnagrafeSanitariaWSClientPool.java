...
public class AnagrafeSanitariaWSClientPool {

	String auraUser;
	String auraPassword;
	String auraURL;

	public AnagrafeSanitariaSoap getClient() {
		...
		factory.setServiceClass(AnagrafeSanitariaSoap.class);
		factory.setAddress(auraURL);
		factory.getOutInterceptors().add(wssOut);

		return (AnagrafeSanitariaSoap) factory.create();
	}
