...
public class DichiarazioneDettaglio   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, stato, genitoreTutoreCuratore, ruoloGenitoreTutoreCuratore, figlioTutelatoCurato, ruoloFiglioTutelatoCurato, documento, noteRevocaBlocco);
  }
