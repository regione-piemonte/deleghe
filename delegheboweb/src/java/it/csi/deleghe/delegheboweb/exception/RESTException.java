...
******************************************************************************/
package it.csi.deleghe.delegheboweb.exception;
...
public class RESTException extends RuntimeException {
	...
	public RESTException(DelegheBoWebStatus status, MediaType mediaType, Object entity, String message) {
		this(status.getStatusCode(),mediaType,entity, message);
	}
	...
	public RESTException(DelegheBoWebStatus status, String string) {
		this(status.getStatusCode(),MediaType.TEXT_HTML_TYPE, string, string);
	}
